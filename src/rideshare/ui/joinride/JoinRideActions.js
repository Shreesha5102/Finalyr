...
export function joinRide(ride_number, payment,destination) {
    ...
    return function(dispatch) {
      ...
      web3.eth.getCoinbase((error, coinbase) => {
        ...
        rideshare.deployed().then(function(instance) {
          ...
          rideshareInstance.joinRide(ride_number, destination,{value: parseInt(payment * Math.pow(10,18)), from: coinbase})
